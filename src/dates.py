...
mm = "(0[1-9]|1[0-2])"
yyyy = "([1-2] {0,1}[0-9][0-9][0-9]|[0-9][0-9])" # allows max one space in y yyy
...
pattern_f1 = "(?:0[1-9]| [1-9]|1[0-9]|2[0-9]|3[0-1]|1er) *[\/|\-|\.] *(?:0[1-9]|1[0-2]) *[\/|\-|\.] *(?:[1-2] {0,1}[0-9][0-9][0-9]|[0-9][0-9])"
pattern_f2 = "(?:0[1-9]| [1-9]|1[0-9]|2[0-9]|3[0-1]|1er) *(?:janvier|février|mars|avril|mai|juin|juillet|août|septembre|octobre|novembre|décembre|decembre|fevrier|aout) *(?:[1-2] {0,1}[0-9][0-9][0-9]|[0-9][0-9])"
